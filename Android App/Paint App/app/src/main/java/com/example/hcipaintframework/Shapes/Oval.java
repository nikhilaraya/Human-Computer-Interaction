...
public class Oval implements CanvasShape {
    public final float x1, y1, x2, y2;
    public final Paint pline;

    public Oval(PointF mouseStart, PointF mouseEnd, Paint pline) {
    ...
    public void draw(Canvas canvas) {
        canvas.drawOval(new RectF(this.x1, this.y1, this.x2, this.y2), pline);
    }
}